const STORAGE_KEYS = {
  ...
  FOLLOW_UPS: 'hair_salon_follow_ups',
...
export const storage = {
  ...
  getFollowUps: <T>(defaultValue: T) => getFromStorage(STORAGE_KEYS.FOLLOW_UPS, defaultValue),
  setFollowUps: <T>(value: T) => saveToStorage(STORAGE_KEYS.FOLLOW_UPS, value),
